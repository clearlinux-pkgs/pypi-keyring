...
Source0  : https://files.pythonhosted.org/packages/01/92/9a1973e6132089e1263b0dc545a021d0733bf5d5b6fa19cc7e641e1925ae/keyring-23.7.0.tar.gz
...
%prep
%setup -q -n keyring-23.7.0
cd %{_builddir}/keyring-23.7.0
pushd ..
cp -a keyring-23.7.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1657810396
...
cp %{_builddir}/keyring-23.7.0/LICENSE %{buildroot}/usr/share/package-licenses/pypi-keyring/8e6689d37f82d5617b7f7f7232c94024d41066d1
